...
const (
	...
	// variables.
	ApplicationName = "openefs-csv-feeder"
...
var (
	...
	RootCtx = &cobra.Command{
		Use:     ApplicationName,
		Short:   "A tool for feeding data from csv-files into openefs.",
		Long:    `A tool for feeding data from csv-files into an Open Energy Forecasting Service providing predictions on the local production and consumption of energy.`,
